...
namespace Sudo\Coupon\Providers;
...
class CouponServiceProvider extends ServiceProvider
{
     ...
     */
    protected $commands = [
        'Sudo\Coupon\Commands\CouponSeedCommand'
    ];
    ...
    */
    public function publish()
    {
        if ($this->app->runningInConsole()) {
            ...
            // Chạy riêng
            $this->publishes($all, 'sudo/coupon');
            $this->publishes($assets, 'sudo/coupon/assets');
            $this->publishes($config, 'sudo/coupon/config');
